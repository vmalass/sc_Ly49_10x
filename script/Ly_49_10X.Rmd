...
raw.mRNA <- Read10X(data.dir = "/Users/Margaux/Documents/Margaux/Other_data/Data_Ly49/10X/outs/filtered_feature_bc_matrix/")
...
#mat2 <- NormalizeData(QC)
#mat2 <- FindVariableFeatures(mat2, selection.method = "vst", verbose = FALSE)
#mat2 <- ScaleData(mat2,features = VariableFeatures(mat))
```
```{r, echo=FALSE,  message=FALSE, warning=FALSE}
...
saveRDS(singlet, "/Users/Margaux/Documents/Margaux/Other_data/Data_Ly49/10X/matrix/Singlet_norm.RDS")
